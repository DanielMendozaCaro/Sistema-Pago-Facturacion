...
<body>
    <div id="principal">
        <div id="Banner"><h1>&nbsp;</h1></div>
            ...
            <li><a href="pago.htm">Pagos Clientes</a>
            </ul>
        </div>
    ...
    <table>
        ...
        <tr>
            ...
            <td><form:input path="codigoFactura" class="textbox"/></td>
            <td><form:errors path="codigoFactura" /></td>
        </tr>
        ...
        <tr>
           ...
           <td><form:input path="numeroCuentaDestino" class="textbox"/></td>
           <td><form:errors path="numeroCuentaDestino" /></td>
        </tr>
        
        <tr>
            <td>Monto deposito:</td>
            <td><form:input path="montoDeposito" class="textbox"/></td>
            <td><form:errors path="montoDeposito" /></td>
        </tr>
